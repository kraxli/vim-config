...
augroup filetypedetect "{{{
	...
	autocmd BufRead,BufWinEnter,BufNew,WinNew *.md,*.vimwiki,*.wiki set filetype=markdown syntax=markdown
	autocmd FileType vimwiki,markdown set filetype=markdown syntax=markdown
