...
augroup filetypedetect "{{{
	...
	au! BufNew,BufEnter,BufFilePre,BufCreate,BufEnter,BufNewFile,BufRead,BufWinEnter,BufFilePre *.md,*.markdown,*.wiki,*.vimwiki  setfiletype=vimwiki " vimwiki.markdown set filetype=vimwiki
